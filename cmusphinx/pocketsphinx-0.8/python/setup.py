...
# If there is no /home/bala/cmusphinx/pocketsphinx-0.8/../sphinxbase-0.8 and friends use pkg-config
if '/home/bala/cmusphinx/pocketsphinx-0.8/../sphinxbase-0.8' == '' or '/home/bala/cmusphinx/pocketsphinx-0.8/../sphinxbase-0.8' == '':
    sbconf = pkgconfig('sphinxbase')
    sb_libdirs = sbconf.get('library_dirs', [])
    sb_includes = sbconf.get('include_dirs', [])
else:
    sb_includes = ['/home/bala/cmusphinx/pocketsphinx-0.8/../sphinxbase-0.8/include',
                   '/home/bala/cmusphinx/pocketsphinx-0.8/../sphinxbase-0.8/include']
    sb_libdirs = ['/home/bala/cmusphinx/pocketsphinx-0.8/../sphinxbase-0.8/src/libsphinxbase/.libs']
